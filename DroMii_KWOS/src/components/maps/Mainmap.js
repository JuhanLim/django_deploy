...
import Meuncontrol from '../controls/Meuncontrol';
// import { Container } from 'react-bootstrap';

const layerConfigurations = [
  { name: '전', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_field' } },
  { name: '답', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_ricepaddy' } },
  { name: '과수원', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_orchard' } },
  { name: '목장용지', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_pasture' } },
  { name: '임야', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_forest' } },
  { name: '광천지', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_gwangcheonki' } },
  { name: '대지', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_earth' } },
  { name: '공장용지', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_factory' } },
  { name: '학교용지', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_school' } },
  { name: '주차장, 도로', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_road' } },
  { name: '주유소', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_gasstation' } },
  { name: '체육용지', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_athletic' } },
  { name: '유원지', url: 'http://175.45.204.163/geoserver/yeongju/wms', params: { 'LAYERS': 'yeongju:K_water_amusementpark' } },
];
...
const Mainmap = () => {
  ...
  return (
    <>
    <Container>
      <Meuncontrol onLayerToggle={handleAdditionalLayerVisibility} />
